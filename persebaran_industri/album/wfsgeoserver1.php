...
$wfsUrl = file_get_contents("http://localhost:8080/geoserver/resposni/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=resposni%3AKecamatan_Nganjuk&maxFeatures=50&outputFormat=application%2Fjson");
